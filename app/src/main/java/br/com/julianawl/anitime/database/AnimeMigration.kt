...
class AnimeMigration {
    companion object {
        val migration_1_2 = object : Migration(1, 2) {
            //alteração do que deveria ser null e not null
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL(
                    "CREATE TABLE 'Anime_Novo' " +
        ...
        val migration_2_3 = object : Migration(2, 3) {
            //adição de uma coluna para guardar o status do anime nas listas locais
            override fun migrate(database: SupportSQLiteDatabase) {
